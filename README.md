...
* `show_indicators`: show indicators for buffers in virtual text. See `:help ls` for more information about indicators. Possible values are `before` (before filename), `after` (afted filename), and nil (do not show indicators).
